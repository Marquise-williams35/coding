...
'Three built in functions in python are def, int, and input'
# 2. What data type will the following snippet of code output?
print(30/ 232)
'The data type the snippet of code would output is an int'
...
# Please write your response in complete sentences.
'The difference betheween a parameter and an a arguement A parameter is the variable listed inside the parentheses in the function definition.'
...
# complete sentences.
' function invocation will execute when "something" invokes it.'
...
'- functions are useful in programmng because it tells your code what to do in the '
